                    ...
                    {next === true &&
                        <>
                            ...
                            {(otpVerify === 'success')
                                ...
                                (<button onClick={
                                    handleSubmit
                                } style={{ float: "right" }}><i className="fa-solid fa-right-to-bracket"></i><span>Update</span></button>)

                            }
                            {
                                (otpVerify === 'fail' || otpVerify === '')
                                &&
                                <button className='disable' style={{ float: "right" }}><i className="fa-solid fa-right-to-bracket"></i><span>Update</span></button>
                            }
